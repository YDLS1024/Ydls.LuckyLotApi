...
{
    [DbContext(typeof(LuckyLotApiDbContext))]
    [Migration("20260526140934_LuckyLotsEntity")]
    partial class LuckyLotsEntity
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Ydls.LuckyLotApi.LuckyLots.Experts", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double?>("WinningRate")
                        .HasColumnType("double precision");

                    b.HasKey("Id");

                    b.ToTable("AppExperts", (string)null);
                });

            modelBuilder.Entity("Ydls.LuckyLotApi.LuckyLots.KillNumbers", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.PrimitiveCollection<short[]>("KillNumber")
                        .IsRequired()
                        .HasColumnType("smallint[]");
                    ...
                    b.ToTable("AppKillNumbers", (string)null);
                });

            modelBuilder.Entity("Ydls.LuckyLotApi.LuckyLots.NumberThree", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<short>("One")
                        .HasColumnType("smallint");

                    b.Property<DateTime>("OpenDate")
                        .HasColumnType("timestamp without time zone");

                    b.Property<short>("Three")
                        .HasColumnType("smallint");

                    b.Property<short>("Two")
                        .HasColumnType("smallint");

                    b.HasKey("Id");

                    b.ToTable("AppNumberThree", (string)null);
                });
            ...
            modelBuilder.Entity("Ydls.LuckyLotApi.LuckyLots.KillNumbers", b =>
                {
                    b.HasOne("Ydls.LuckyLotApi.LuckyLots.Experts", "Expert")
                        .WithMany("KillNumbers")
