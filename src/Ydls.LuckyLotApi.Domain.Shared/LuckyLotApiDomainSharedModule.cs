...
public class LuckyLotApiDomainSharedModule : AbpModule
{
    public override void PreConfigureServices(ServiceConfigurationContext context)
    {
        LuckyLotApiGlobalFeatureConfigurator.Configure();
        LuckyLotApiModuleExtensionConfigurator.Configure();
    }
    ...
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        {
            options.FileSets.AddEmbedded<LuckyLotApiDomainSharedModule>();
        });

        Configure<AbpLocalizationOptions>(options =>
        {
            options.Resources
                .Add<LuckyLotApiResource>("en")
                .AddBaseTypes(typeof(AbpValidationResource))
                .AddVirtualJson("/Localization/LuckyLotApi");

            options.DefaultResourceType = typeof(LuckyLotApiResource);
        ...
        {
            options.MapCodeNamespace("LuckyLotApi", typeof(LuckyLotApiResource));
        });
    }
}
